...
import { 
  ShoppingBag, AlertTriangle, Home, LayoutDashboard, 
  Headphones, ChevronRight, ArrowLeft, ShieldCheck, 
  Truck, RefreshCcw 
} from "lucide-react";
    ...
    <div className="min-h-screen bg-sabi-surface flex flex-col font-sans relative overflow-hidden selection:bg-sabi-primary selection:text-white">
        ...
        <div className="w-full max-w-3xl bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 p-6 sm:p-10 text-center animate-in zoom-in-95 duration-300">
          ...
          <div className="bg-gray-50 rounded-2xl p-2 mb-8 text-left border border-gray-100">
            ...
            <div className="space-y-1">
               <Link to="/" className="flex items-center justify-between p-3.5 hover:bg-white rounded-xl transition-all group border border-transparent hover:border-gray-100 hover:shadow-sm">
                 <div className="flex items-center gap-3">
                   ...
                   <span className="font-bold text-gray-700 text-sm">Visit Homepage</span>
                 </div>
                 <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-sabi-primary transition-colors" />
               </Link>

               <Link to="/dashboard" className="flex items-center justify-between p-3.5 hover:bg-white rounded-xl transition-all group border border-transparent hover:border-gray-100 hover:shadow-sm">
                 <div className="flex items-center gap-3">
                   ...
                   <span className="font-bold text-gray-700 text-sm">Go to Dashboard</span>
                 </div>
                 <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-blue-600 transition-colors" />
               </Link>

               <Link to="/contact" className="flex items-center justify-between p-3.5 hover:bg-white rounded-xl transition-all group border border-transparent hover:border-gray-100 hover:shadow-sm">
                 <div className="flex items-center gap-3">
                   ...
                   <span className="font-bold text-gray-700 text-sm">Contact Support</span>
                 </div>
      ...
      <footer className="w-full pb-8 px-4 relative z-10 text-center">
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-xs font-bold text-gray-500 mb-4">
          ...
          <span className="flex items-center gap-1.5"><RefreshCcw className="w-4 h-4 text-purple-500" /> Easy Returns</span>
        </div>
        <div className="inline-flex items-center gap-1 text-xs font-medium text-gray-400">
           Powered by <Logo className="w-3 h-3 grayscale opacity-50 ml-1" showText={false}/> <span className="font-bold text-gray-500">SabiSell</span>
        </div>
      </footer>
