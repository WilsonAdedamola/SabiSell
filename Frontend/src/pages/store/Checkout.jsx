...
const Checkout = () => {
  ...
  const deliveryOptions = {
    ...
    negotiated: {
      name: "Pay Delivery Later",
      price: 0,
      eta: "Vendor will contact you with fee",
      icon: Phone,
    },
  };
        ...
        try {
          ...
          if (paymentMethod === "paystack") {
            if (!response.data.access_code || !response.data.publicKey) {
              throw new Error(
                "Backend failed to return Paystack access code or public key.",
              );
            }
    ...
    <div className="min-h-screen bg-[#FDFDFB] font-sans pb-16 relative overflow-hidden">
          ...
          <div className="flex items-center justify-center max-w-2xl mx-auto mt-6 mb-4 relative">
            ...
            <div
              ...
              style={{
                ...themeStyle,
                right:
                  currentStep === 2 ? "66%" : currentStep === 3 ? "33%" : "8%",
              }}
            ></div>
            ...
            <div className="flex justify-between w-full relative z-10">
              ...
              <div className="flex flex-col items-center gap-2 bg-white px-2">
                <div
                  className={`w-6 h-6 rounded-full flex items-center justify-center font-bold text-xs shadow-sm ${currentStep >= 2 ? "text-white" : "border-2 border-gray-200 text-gray-400 bg-white"}`}
                  style={currentStep >= 2 ? themeStyle : {}}
                >
                  {currentStep > 2 ? <CheckCircle2 className="w-4 h-4" /> : "2"}
                </div>
                <span
                  className={`text-[10px] font-bold ${currentStep >= 2 ? "text-gray-900" : "text-gray-400"}`}
                >
                  Checkout
                </span>
              </div>
              <div className="flex flex-col items-center gap-2 bg-white px-2">
                <div
                  className={`w-6 h-6 rounded-full flex items-center justify-center font-bold text-xs shadow-sm transition-colors ${currentStep >= 3 ? "text-white" : "border-2 border-gray-200 text-gray-400 bg-white"}`}
                  style={currentStep >= 3 ? themeStyle : {}}
                >
                  {currentStep > 3 ? <CheckCircle2 className="w-4 h-4" /> : "3"}
                </div>
                <span
                  className={`text-[10px] font-bold ${currentStep >= 3 ? "text-gray-900" : "text-gray-400"}`}
                >
                  Payment
                </span>
              </div>
              <div className="flex flex-col items-center gap-2 bg-white px-2">
                <div
                  className={`w-6 h-6 rounded-full flex items-center justify-center font-bold text-xs shadow-sm transition-colors ${currentStep >= 4 ? "text-white" : "border-2 border-gray-200 text-gray-400 bg-white"}`}
                  style={currentStep >= 4 ? themeStyle : {}}
                >
                  4
                </div>
                <span
                  className={`text-[10px] font-bold ${currentStep >= 4 ? "text-gray-900" : "text-gray-400"}`}
                >
                  Confirmation
                </span>
              </div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            <div className="lg:col-span-7 xl:col-span-7">
              ...
              >
                ...
                <section>
                  ...
                  <div className="pl-0 sm:pl-9 space-y-4">
                    <div className="relative mb-4">
                      <label className="absolute top-2 left-4 text-[10px] font-bold text-gray-400 uppercase z-10">
                        Country / Region
                      </label>
                      <select
                        name="country"
                    ...
                    {formData.country === "Nigeria" ? (
                      <>
                        <div className="relative">
                          <label className="absolute top-2 left-4 text-[10px] font-bold text-gray-400 uppercase">
                            Address
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <div className="relative flex flex-col">
                            ...
                            <p className="text-[10px] text-gray-500 mt-1 ml-1 leading-tight">
                              A popular building or place near you to help the
                              driver.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-800 mt-1 leading-relaxed">
                            International shipping fees vary depending on the
                            weight of the goods and the destination distance.
                            The vendor will contact you via phone or email to
                            collect your full delivery address, calculate the
                            exact shipping cost, and provide further
                            information.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="relative mt-2">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        placeholder={
                          formData.country === "International Shipping"
                            ? "Please provide any specific delivery details or instructions..."
                            : "Add any special instructions for the vendor..."
                        }
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h4 className="text-sm font-bold text-emerald-900">
                                Good news! We deliver to {formData.city}
                              </h4>
                              <p className="text-xs font-medium text-emerald-700 mt-0.5">
                                Estimated delivery:{" "}
                                {deliveryOptions[deliveryMethod].eta}
                              </p>
                            </div>
                          </div>
                ...
                <section>
                  ...
                  <p className="text-sm font-medium text-gray-500 mb-6 pl-9">
                  ...
                  <div className="pl-0 sm:pl-9 space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="relative">
                        ...
                        />
                        {phoneError && (
                          <p className="text-[10px] text-red-500 font-bold mt-1 absolute -bottom-4 left-2">
                            {phoneError}
                          </p>
                        )}
                      </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-right">
                            {option.price === 0 ? (
                              <span className="font-bold text-gray-600 text-sm block">
                                Calculated Later
                              </span>
                            ) : (
                ...
                <section>
                  ...
                  <div className="pl-0 sm:pl-9 space-y-3">
                    <label
                      ...
                      style={
                        paymentMethod === "paystack" ? borderThemeStyle : {}
                      }
                      onClick={() => setPaymentMethod("paystack")}
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${paymentMethod === "paystack" ? "border-transparent" : "border-gray-300"}`}
                        >
                      ...
                      <div className="flex items-center gap-1 opacity-80">
                        <span className="text-[10px] font-extrabold text-blue-800 italic pr-1">
                          VISA
                        </span>
                        ...
                        <span className="text-[10px] font-extrabold text-red-600 pl-1">
                          Verve
                        </span>
                      </div>
                    </label>
            ...
            <div className="lg:col-span-5 xl:col-span-5">
              <div className="bg-[#FAF9F5] border border-gray-200 rounded-4xl p-6 sm:p-8 lg:sticky lg:top-24">
          ...
          <div className="bg-white rounded-3xl border border-gray-100 shadow-xl p-8 sm:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <p className="text-gray-500 font-medium">
                Please wait while we securely process your order via{" "}
      ...
      {currentStep === 4 && mockOrder && (
        <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-20 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div
            className="w-24 h-24 sm:w-28 sm:h-28 rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg border-4 border-white relative z-10"
            style={themeStyle}
          >
          ...
          <div className="bg-white rounded-4xl border border-gray-100 shadow-sm p-6 sm:p-10 text-left mb-10 relative overflow-hidden">
            <div
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs font-medium text-gray-500 mt-1 leading-relaxed">
                    ...
                    <strong className="text-gray-900">{mockOrder.email}</strong>{" "}
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-gray-900">
                    Delivery Method: {mockOrder.deliveryMethodName}
                  </h4>
                  <p className="text-xs font-medium text-gray-500 mt-1 leading-relaxed">
