...
import { 
  Store, ExternalLink, Copy, TrendingUp, ShoppingCart, 
  Users, Package, ChevronRight, Share2, Wallet, Plus, Tag, ClipboardList, HelpCircle, Settings, CreditCard, QrCode,
} from "lucide-react";
      ...
      <div className="bg-[#044e3b] rounded-4xl p-6 lg:p-8 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden shadow-xl">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-5 z-10 w-full md:w-auto text-center sm:text-left">
           ...
           <div>
              ...
              <p className="text-emerald-100/90 text-sm lg:text-base font-medium">Here's what's happening with your store today.</p>
           </div>
        </div>
        ...
        <div className="flex flex-col gap-3 z-10 w-full md:w-auto">
           ...
           <div className="flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 transition-colors rounded-xl p-3 cursor-pointer">
              <span className="text-emerald-50 text-sm font-medium truncate max-w-45">sabisell.com/zara-stitches</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="flex justify-between items-start mb-6">
               <div>
                  ...
                  <div className="flex items-center gap-4 mt-2">
                     <div className="flex items-center gap-1.5 text-xs font-bold text-gray-600"><span className="w-2 h-2 rounded-full bg-sabi-primary"></span> This Month</div>
                     <div className="flex items-center gap-1.5 text-xs font-bold text-gray-400"><span className="w-2 h-2 rounded-full bg-emerald-200"></span> Last Month</div>
                  </div>
               </div>
         ...
         <div className="lg:col-span-4 bg-white rounded-4xl p-6 border border-gray-100 shadow-sm flex flex-col h-100">
            <div className="flex justify-between items-center mb-6">
               ...
               <Link to="/dashboard/orders" className="text-sabi-primary text-sm font-bold flex items-center hover:underline">View All <ChevronRight className="w-4 h-4"/></Link>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
         ...
         <div className="lg:col-span-4 bg-white rounded-4xl p-6 border border-gray-100 shadow-sm">
            <div className="flex justify-between items-center mb-6">
               ...
               <Link to="/dashboard/products" className="text-sabi-primary text-sm font-bold flex items-center hover:underline">View All <ChevronRight className="w-4 h-4"/></Link>
            </div>
         ...
         <div className="lg:col-span-4 bg-[#064e3b] rounded-4xl p-6 border border-[#065f46] shadow-xl relative overflow-hidden flex flex-col justify-center">
            ...
            <div className="relative z-10">
               ...
               <p className="text-emerald-100/90 text-sm font-medium mb-6 leading-relaxed">
                  Connect Paystack or Flutterwave to receive payments directly from customers securely.
               </p>
