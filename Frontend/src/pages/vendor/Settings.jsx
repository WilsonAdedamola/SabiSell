...
import {
  ...
  ExternalLink, Camera, Landmark, Wallet, Globe, XCircle, Eye, ArrowLeft
} from "lucide-react";
...
const Settings = () => {
  ...
  const settingsMenu = [
    ...
    { id: "appearance", icon: Palette, title: "Store Appearance", desc: "Banner, colors, logo", color: "text-purple-600 bg-purple-50", border: "hover:border-purple-200" },
    ...
    { id: "delivery", icon: Truck, title: "Delivery & Shipping", desc: "Fees, timeframes", color: "text-indigo-600 bg-indigo-50", border: "hover:border-indigo-200" },
  ];
  ...
  return (
    // FIX 1: We moved the padding-bottom entirely off the scrollable parent container
    <div id="settings-scroll-area" className="flex-1 overflow-y-auto bg-gray-50/50 w-full h-full relative">
      
      {/* FIX 2: We placed the padding on this inner container, forcing the browser to calculate it properly */}
      <div className="w-full max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 pb-32 sm:pb-12">
        ...
        {/* ========================================== */}
        {activeView !== "menu" && (
          // FIX 3: Removed overflow-hidden from the form container so mobile heights are unrestrained
          <div className="w-full bg-white rounded-[2rem] border border-gray-200 shadow-sm animate-in slide-in-from-right-8 duration-300">
              ...
              {activeView === "appearance" && (
                <div className="space-y-10 animate-in fade-in duration-300">
                  ...
                  <div className="relative">
                    ...
                    <div className={`border border-gray-200 rounded-3xl p-5 sm:p-6 bg-gray-50/50 ${!isPremium ? 'opacity-70 pointer-events-none select-none' : ''}`}>
                ...
                <div className="space-y-8 animate-in fade-in duration-300">
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-medium text-gray-500 mt-2">Leave blank if you negotiate delivery on WhatsApp.</p>
                    </div>
                  ...
                  {!isPremium && (
                    <div className="bg-indigo-50 border border-indigo-100 rounded-3xl p-5 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
                       <div>
                         <h4 className="text-sm font-bold text-indigo-900 mb-1.5">Advanced Delivery Rules</h4>
                         <p className="text-xs font-medium text-indigo-700 max-w-sm leading-relaxed">
                           Upgrade to Starter to set specific delivery prices for different states or offer "Free Delivery" thresholds.
                         </p>
                       </div>
                       <Link to="/dashboard/billing" className="text-xs font-bold bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl shadow-sm transition-colors whitespace-nowrap w-full sm:w-auto text-center">
                         Upgrade Plan
                       </Link>
                    </div>
                  )}
            ...
            {/* FIX 4: Replaced arbitrary bottom padding with a solid, invisible spacer block */}
