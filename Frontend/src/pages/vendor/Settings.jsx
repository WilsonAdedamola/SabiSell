...
const Settings = () => {
  ...
  const settingsMenu = [
    ...
    },
    {
      ...
      desc: "Bank, wallet, payout settings",
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 pb-24 lg:pb-12 w-full">
      <div className="w-full max-w-7xl mx-auto h-full flex flex-col lg:flex-row gap-6 lg:gap-8 animate-in fade-in duration-300 items-start">
        ...
        <div
          className={`w-full lg:w-95 xl:w-105 shrink-0 flex-col gap-6 ${mobileView === "detail" ? "hidden lg:flex" : "flex"}`}
        >
          <h1 className="text-2xl font-extrabold text-gray-900 hidden lg:block">
            Store Settings
          </h1>
          ...
          <div className="bg-white rounded-3xl p-5 border border-gray-200 shadow-sm flex items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-emerald-900 rounded-xl flex flex-col items-center justify-center text-white border-2 border-emerald-100 shadow-sm shrink-0">
                <span className="font-bold text-xl italic leading-none">
                  Zara
                </span>
                <span className="text-[6px] tracking-widest uppercase opacity-80 mt-0.5">
                  Fashion
                </span>
              </div>
              <div>
                <h3 className="font-bold text-gray-900 text-base leading-tight">
                  Zara Stitches & Fashion
                </h3>
                <p className="text-xs font-medium text-gray-500 mb-2">
                  zara-fashion.sabisell.com
                </p>
            ...
            >
              <div
                className={`w-4 h-4 bg-white rounded-full shadow-sm transform transition-transform duration-200 ease-in-out ${isStoreOnline ? "translate-x-6" : "translate-x-0"}`}
              ></div>
            </div>
          </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {item.badge && (
                        <span className="bg-purple-600 text-white text-[9px] font-extrabold uppercase px-1.5 py-0.5 rounded">
                          {item.badge}
                        </span>
                      )}
                    </div>
        ...
        <div
          className={`w-full flex-1 flex-col bg-white lg:rounded-4xl border-x lg:border border-gray-200 lg:shadow-sm overflow-hidden ${mobileView === "menu" ? "hidden lg:flex" : "flex"} min-h-150 -mx-4 sm:mx-0 sm:border-x-0`}
        >
          {/* Detail Header */}
          <div className="h-16 border-b border-gray-100 flex items-center justify-between px-4 sm:px-6 sticky top-0 bg-white z-10 shrink-0">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-extrabold text-gray-900">
                {settingsMenu.find((s) => s.id === activeView)?.title ||
                  "Settings"}
              </h2>
            </div>
            ...
            {activeView === "store-info" ? (
              <div className="space-y-8 max-w-2xl animate-in fade-in slide-in-from-right-4 duration-300 pb-8">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="relative w-24 h-24 rounded-full bg-emerald-900 flex flex-col items-center justify-center text-white border-4 border-emerald-50 shadow-sm shrink-0">
                      <span className="font-bold text-2xl italic leading-none">
                        Zara
                      </span>
                      <span className="text-[8px] tracking-widest uppercase opacity-80 mt-1">
                        Fashion
                      </span>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    defaultValue="Zara Stitches & Fashion"
                ...
                <div>
                  ...
                  <div className="flex bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm focus-within:ring-2 focus-within:ring-sabi-primary/20 focus-within:border-sabi-primary transition-all">
                    <input
                      type="text"
                      defaultValue="zara-fashion"
                      className="w-full px-4 py-3.5 focus:outline-none font-bold text-gray-900"
                    />
              ...
              <div className="flex flex-col items-center justify-center h-full min-h-100 text-center px-4 animate-in fade-in duration-300">
                ...
                <p className="text-sm text-gray-500 max-w-sm">
                  The settings configuration for{" "}
